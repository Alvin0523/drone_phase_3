...
if("TRUE" STREQUAL "TRUE")
  set(ekf_SOURCE_PREFIX /home/wm_u26/hkust/elec5660_proj3/proj3phase1/catkin_ws/src/ekf)
  set(ekf_DEVEL_PREFIX /home/wm_u26/hkust/elec5660_proj3/proj3phase1/catkin_ws/devel)
  set(ekf_INSTALL_PREFIX "")
  set(ekf_PREFIX ${ekf_DEVEL_PREFIX})
else()
  set(ekf_SOURCE_PREFIX "")
  set(ekf_DEVEL_PREFIX "")
  set(ekf_INSTALL_PREFIX /home/wm_u26/hkust/elec5660_proj3/proj3phase1/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ekf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wm_u26/hkust/elec5660_proj3/proj3phase1/catkin_ws/src/ekf/${idir}'.  ${_report}")
    endif()
